...
<p align="center">
  <a href="docs/images/enjoy-git.gif">
    <img src="docs/images/enjoy-git.gif" alt="Enjoy Git 應用演示：多倉庫分頁、暫存區、雙欄 diff、提交歷史" width="920" />
  </a>
</p>
<p align="center"><sub>典型工作流錄屏（點擊可查看原圖）· 支援深色 / 淺色主題</sub></p>

三欄布局：左側導覽、中間檔案列表、右側 diff 與提交區；頂部可多標籤同時開啟多個倉庫。
