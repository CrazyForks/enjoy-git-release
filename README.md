...
## Main Interface & Multi-Repository Management

<p align="center">
  <a href="docs/images/enjoy-git.gif">
    <img src="docs/images/enjoy-git.gif" alt="Enjoy Git demo: multi-repo tabs, staging, side-by-side diff, commit history" width="920" />
  </a>
</p>
<p align="center"><sub>Typical workflow screen recording (click for full size) · dark and light themes supported</sub></p>

Three-column layout: left navigation, center file list, right diff and commit area; multiple repositories open in tabs at the top.
